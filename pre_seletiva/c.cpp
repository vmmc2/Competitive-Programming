...
int main(){
    ...
    while(scanf("%d", &numplayers) == 1){
        ...
        for(int i = 0; i < numplayers; i++){
            ...
            int v[25];
            char nome[100];
            scanf("%[^;];%d %d %d %d %d;%d %d %d %d %d;%d %d %d %d %d;%d %d %d %d %d;%d %d %d %d %d",nome, &v[0], &v[1], &v[2], &v[3], &v[4], &v[5], &v[6], &v[7], &v[8], &v[9], &v[10], &v[11], &v[12], &v[13], &v[14], &v[15], &v[16], &v[17], &v[18], &v[19], &v[20], &v[21], &v[22], &v[23], &v[24]);
            //printf("%s\n", nome);
            for(int i = 0; i < 25; i++){
        ...
        for(int i = 0; i < (int)registro.size(); i++){
            cout << registro[i].real_name << " " << registro[i].points;
        }
        printf("\n");
        caso++;
    }
